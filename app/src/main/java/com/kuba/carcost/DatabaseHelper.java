...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COST_COL_4 = "cost_data";
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            db.execSQL("CREATE TABLE cost (" +
                    ...
                    "fuel_unit_amount double NOT NULL," +
                    "fuel_unit_price double NOT NULL," +
                    "fuel_full integer NOT NULL," +
                    "fuel_tank_num integer NOT NULL," +
    ...
    public boolean updateVehicleData(int id, int user_id, String name, int fuel_type_1, int tank_volume_1,
                                     int fuel_type_2, int tank_volume_2) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(VEHICLE_COL_2, user_id);
    ...
    public Cursor getCost() {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM " + COST_TABLE, null);
        return res;
    }
